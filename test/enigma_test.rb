...
class EnigmaTest < Minitest::Test
  ...
  def test_if_encrypt_method_returns_a_string
    assert_equal String, @e.encrypt("hello world").class
  end

  def test_it_can_encrypt_a_letter
    my_message = "k..end.."

    assert_equal "308o658i", @e.encrypt(my_message)
  end

  def test_it_can_encrypt_a_second_letter
    my_message = "ki..end.."

    assert_equal "3 8ixcair", @e.encrypt(my_message)
  end

  def test_it_can_encrypt_a_four_letter_word
    my_message = "bell..end.."

    assert_equal "u6ivr0bxw08", @e.encrypt(my_message)
  end

  def test_it_can_encrypt_two_words
    my_message = "bell hop..end.."

    assert_equal "u6ivq9lzr0bxw08", @e.encrypt(my_message)
  end
